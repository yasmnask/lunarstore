...
class Sidebar {
   ...
   */
  onResize() {
    // Only auto-show on desktop if the sidebar wasn't manually hidden
    if (isDesktop(window) && !this.sidebarEL.classList.contains("inactive")) {
      this.sidebarEL.classList.add("active");
    } else if (!isDesktop(window)) {
   ...
   */
  toggle() {
    const hasActiveClass = this.sidebarEL.classList.contains("active");
    console.log("Delayed check - Has active class:", hasActiveClass);
   ...
   */
  hide() {
    console.log("Before hide:", this.sidebarEL.classList.value);
    this.sidebarEL.classList.remove("active");
    this.sidebarEL.classList.add("inactive");
    console.log("After hide:", this.sidebarEL.classList.value);
    this.deleteBackdrop();
  ...
  show() {
    console.log("Before show:", this.sidebarEL.classList.value);
    this.sidebarEL.classList.add("active");
    this.sidebarEL.classList.remove("inactive");
    console.log("After show:", this.sidebarEL.classList.value);
    this.createBackdrop();
    this.toggleOverflowBody();
  }
