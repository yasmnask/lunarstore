    ...
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                <div class="logo">
                    <a href="{{ route('admin.dashboard') }}" wire:navigate class="d-flex align-items-center gap-3">
                        <img style="width: 50px; height: 50px;" src="<?= asset('assets/client/images/logo.png') ?>"
                            alt="Logo">
                        <h6 class="mt-2">Lunar Store Admin</h6>
                    </a>
                </div>
