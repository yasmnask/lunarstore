        ...
        <div class="grid gap-8 md:grid-cols-4">
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <a href="#" onclick="event.preventDefault(); alert('Coming Soon!');"
                    ...
                    <a href="https://instagram.com/lunaryst" target="_blank"
                        class="text-gray-400 transition-colors hover:text-white">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd"
            ...
            <div>
                ...
                <ul class="space-y-6">
                    <li>
                        <a href="" class="text-gray-400 transition-colors hover:text-white">Premium Apps</a>
                    </li>
                    <li>
                        <a href="" class="text-gray-400 transition-colors hover:text-white">Top Up Mobile
                            Legends</a>
                    </li>
                    <li>
